...
`input` is a single-line text field. The engine owns its editing state per
...
under 30px — described in [keyboards.md](keyboards.md#exclusive-the-keyboard-takes-the-display).)
