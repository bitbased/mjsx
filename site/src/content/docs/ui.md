---
title: "The app-author API"
description: "h(), state, memo, scrolling, and the pointer model."
---
<!-- GENERATED from docs/ui.md by scripts/docs-sync.mjs. Edit that file. -->Everything here is implemented in `packages/core/src/mjsx.js` and works the
