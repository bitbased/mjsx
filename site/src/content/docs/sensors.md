...
description: "Motion, GPIO and I2C from JavaScript."
---
<!-- GENERATED from docs/sensors.md by scripts/docs-sync.mjs. Edit that file. -->The ESP32 bridge firmware carries a motion module: the QMI8658 the
...
[`hardware-api.md`](/hardware-api); this page cross-references it
...
[`hardware-api.md`](/hardware-api#board-pin-notes)).
...
[`consistency.md`](/consistency)) — it is a device native, and the
...
is in [`hardware-api.md`](/hardware-api). The rules that matter most
...
loop, [`round.md`](/round) for the round board's layout rules.
