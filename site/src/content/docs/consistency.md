---
title: "Cross-backend consistency audit"
description: "What each backend really implements, and where they differ."
---
<!-- GENERATED from docs/consistency.md by scripts/docs-sync.mjs. Edit that file. -->What each backend in this tree *actually* implements, measured against
