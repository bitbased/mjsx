---
title: "console.log, and where it goes"
---
<!-- GENERATED from docs/logging.md by scripts/docs-sync.mjs. Edit that file. -->MicroQuickJS has no `console`. That is a small gap with a large consequence:
